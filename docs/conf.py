...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.napoleon', 'sphinx.ext.autosectionlabel', 'sphinx_sitemap']
...
# Set up the homebase url for sitemap configuration
html_baseurl = 'https://albertogeniola.github.io/MerossIot/'
